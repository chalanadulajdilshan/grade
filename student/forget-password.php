...
<head>
	...
	<title>Aswanna.edu.lk - Forget Password</title>
...
<body class="hold-transition theme-primary bg-img someBlock" style="background-image: url(images/auth-bg/bg-1.jpg)">
								...
								<form id="form">
									<div class="form-group">
										...
										<div class="input-group mb-3">
											...
											<input type="text" class="form-control pl-15 bg-transparent" placeholder="Please enter Mobile Number" name="mobile_number" id="mobile_number">
									...
									<div class="row">
										...
										<div class="col-12 text-center">
											<button type="submit" class="btn btn-danger mt-10" id="change">Submit</button>
										</div> 
									</div>
								</form>

								<div class="text-center">
									<p class="mt-15 mb-0">Do you have an account? <a href="#" class="text-warning ml-5">Registration</a></p>
								</div>
	...
	<script src="ajax/js/forget-password.js"></script>
