                            ...
                            <div class="blog-comment">
                                ...
                                <div class="comment-1">
                                    <div class="comment-photo">
                                        <img class="img-fluid" src="assets/images/front-end-img/avatar/1.jpg" alt="">
                                    </div>
                                ...
                                <div class="comment-1 comment-2">
                                    <div class="comment-photo">
                                        <img class="img-fluid" src="assets/images/front-end-img/avatar/2.jpg" alt="">
                                    </div>
                                    <div class="comment-info">
                                        <h4 class="theme-color"> Kevin Martin <span>Sep 15, 2020</span></h4>
                                        <div class="port-post-social float-end">
                                ...
                                <div class="comment-1 comment-2">
                                    <div class="comment-photo">
                                        <img class="img-fluid" src="assets/images/front-end-img/avatar/3.jpg" alt="">
                                    </div>
                                    <div class="comment-info">
                                        <h4 class="theme-color"> Kevin Martin <span>Sep 15, 2020</span></h4>
                                        <div class="port-post-social float-end">
                                ...
                                <div class="comment-1">
                                    <div class="comment-photo">
                                        <img class="img-fluid" src="assets/images/front-end-img/avatar/4.jpg" alt="">
                                    </div>
                                    <div class="comment-info">
                                        <h4 class="theme-color"> Kevin Martin <span>Sep 15, 2020</span></h4>
                                        <div class="port-post-social float-end">
                        ...
                        <div class="widget">
                            ...
                            <div class="recent-post clearfix">
                                <div class="recent-post-image">
                                    <img class="img-fluid bg-primary-light" src="assets/images/front-end-img/courses/cor-logo-1.png" alt="">
                                </div>
                            ...
                            <div class="recent-post clearfix">
                                <div class="recent-post-image">
                                    <img class="img-fluid bg-primary-light" src="assets/images/front-end-img/courses/cor-logo-5.png" alt="">
                                </div>
                                <div class="recent-post-info">
                                    <a href="#">Curabitur id scelerisque diam. Pellentesque ut lectus arcu.</a>
                                    <span><i class="fa fa-calendar-o"></i> September 30, 2020</span>
                            ...
                            <div class="recent-post clearfix">
                                <div class="recent-post-image">
                                    <img class="img-fluid bg-primary-light" src="assets/images/front-end-img/courses/cor-logo-4.png" alt="">
                                </div>
                                <div class="recent-post-info">
                                    <a href="#">Curabitur id scelerisque diam. Pellentesque ut lectus arcu.</a>
                                    <span><i class="fa fa-calendar-o"></i> September 30, 2020</span>
