...
<head>
	...
	<title>AswannaCollage.lk - Log in </title>
								...
								<form id="form">
									...
									<label>User Name</label>
										<div class="input-group mb-3">
											...
											<input type="text" class="form-control pl-15 bg-transparent" placeholder="Username" name="username" data-field="username">
											<div class="col-md-12">
									...
									<div class="form-group">
										...
										<div class="input-group mb-3">
											...
											<input type="password" class="form-control pl-15 bg-transparent" placeholder="Password" name="password" id="password" data-field="password">
											<div class="col-md-12">
												<div class="valid-message"></div>
											</div>
										</div>
