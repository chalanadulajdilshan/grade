 ...
 <head>
     ...
     <title>Aswanna.edu.lk - About us</title>
     <!-- Vendors Style-->
 ...
 <body class="theme-primary">
             ...
             <div class="row align-items-center">
                 ...
                 <div class="col-lg-6 col-12 position-relative">
                     <div class="popup-vdo mt-30 mt-md-0">
                         <img src="assets/images/front-end-img/courses/4f.jpg" class="img-fluid rounded" alt="">
                 ...
                 <div class="col-12">
                     <div class="owl-carousel owl-theme owl-btn-1" data-nav-arrow="true" data-nav-dots="false" data-items="1" data-md-items="1" data-sm-items="1" data-xs-items="1" data-xx-items="1">
                         <div class="item">
                             <div class="text-center">
                                 <div class="bg-primary-light w-50 mx-auto rounded-circle overflow-hidden">
                                     <img src="assets/images/front-end-img/avatar/4.jpg" class="avatar-lg w-auto" alt="">
                                 </div>
                         ...
                         <div class="item">
                             <div class="text-center">
                                 <div class="bg-primary-light w-50 mx-auto rounded-circle overflow-hidden">
                                     <img src="assets/images/front-end-img/avatar/5.jpg" class="avatar-lg w-auto" alt="">
                                 </div>
                                 <div class="max-w-750 mx-auto">
                                     <div class="testimonial-info">
                                         <h4 class="name mb-0 mt-10">Peter Packer</h4>
                         ...
                         <div class="item">
                             <div class="text-center">
                                 <div class="bg-primary-light w-50 mx-auto rounded-circle overflow-hidden">
                                     <img src="assets/images/front-end-img/avatar/9.jpg" class="avatar-lg w-auto" alt="">
                                 </div>
                                 <div class="max-w-750 mx-auto">
                                     <div class="testimonial-info">
                                         <h4 class="name mb-0 mt-10">Peter Packer</h4>
     ...
     <section class="py-100" data-jarallax='{"speed": 0.4}' style="background-image: url(assets/images/front-end-img/background/bg-3.jpg);" data-overlay="5">
         <div class="container">
             <div class="row justify-content-center">
                 <div class="col-lg-8 col-12">
                     <div class="text-center text-white">
                         <h2 class="mb-15 fw-600 fs-40">Best Education Campus <br> on your time</h2>
             ...
             <div class="row">
                 <div class="col-12 col-lg-3 col-md-6">
                     <div class="box">
                         <div class="box-header no-border p-0">
                             <a href="#">
                                 <img class="img-fluid" src="assets/images/front-end-img/avatar/375x200/1.jpg" alt="">
                             </a>
                         </div>
                         <div class="box-body">
                             <div class="text-center">
                 ...
                 <div class="col-12 col-lg-3 col-md-6">
                     <div class="box">
                         <div class="box-header no-border p-0">
                             <a href="#">
                                 <img class="img-fluid" src="assets/images/front-end-img/avatar/375x200/8.jpg" alt="">
                             </a>
                         </div>
                         <div class="box-body">
                             <div class="text-center">
                 ...
                 <div class="col-12 col-lg-3 col-md-6">
                     <div class="box">
                         <div class="box-header no-border p-0">
                             <a href="#">
                                 <img class="img-fluid" src="assets/images/front-end-img/avatar/375x200/2.jpg" alt="">
                             </a>
                         </div>
                         <div class="box-body">
                             <div class="text-center">
                 ...
                 <div class="col-12 col-lg-3 col-md-6">
                     <div class="box">
                         <div class="box-header no-border p-0">
                             <a href="#">
                                 <img class="img-fluid" src="assets/images/front-end-img/avatar/375x200/4.jpg" alt="">
                             </a>
                         </div>
                         <div class="box-body">
                             <div class="text-center">
