        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-xl-4 col-md-6 col-12">
                    <div class="blog-post">
                        <div class="entry-image clearfix">
                            <iframe style="height: auto; width: 100%;" src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/118951274&auto_play=false&hide_related=false&show_comments=true&show_user=true&show_reposts=false&visual=true"></iframe>
                        </div>
                        <div class="blog-detail">
                            <div class="entry-title mb-10">
                                <a href="#">Blogpost With Soundcloud Audio</a>
                            </div>
                            <div class="entry-meta mb-10">
                                <ul class="list-unstyled">
                                    <li><a href="#"><i class="fa fa-folder-open-o"></i> Design</a></li>
                        ...
                        <div class="entry-image clearfix">
                            <div class="blog-p-post-you-tube">
                                <div class="cs-video [youtube, widescreen]">
                                    <iframe src="https://player.vimeo.com/video/69437399" width="640" height="360" frameborder="0" webkitallowfullscreen="" mozallowfullscreen="" allowfullscreen=""></iframe>
                                </div>
                            </div>
                        </div>
                        <div class="blog-detail">
                            <div class="entry-title mb-10">
                                <a href="#">Blogpost With Vemio Embeded Video</a>
                            </div>
                            <div class="entry-meta mb-10">
                                <ul class="list-unstyled">
                                    <li><a href="#"><i class="fa fa-folder-open-o"></i> Design</a></li>
                ...
                <div class="col-xl-4 col-md-6 col-12">
                    <div class="blog-post">
                        <div class="entry-image clearfix">
                            <div class="blog-p-post-you-tube">
                                <div class="cs-video [youtube, widescreen]">
                                    <iframe width="560" height="315" src="https://www.youtube.com/embed/34fOZgy4TqI" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen=""></iframe>
                                </div>
                            </div>
                        </div>
                        <div class="blog-detail">
                            <div class="entry-title mb-10">
                                <a href="#">Blogpost With youtube Embeded Video</a>
                            </div>
                            <div class="entry-meta mb-10">
                                <ul class="list-unstyled">
                                    <li><a href="#"><i class="fa fa-folder-open-o"></i> Design</a></li>
                ...
                <div class="col-xl-4 col-md-6 col-12">
                    <div class="blog-post">
                        <div class="blog-entry-html-video clearfix">
                            <video style="width:100%;height:100%;" id="player1" poster="assets/images/front-end-img/courses/10f.jpg" controls="" preload="none">
                        ...
                        <div class="blog-detail">
                            <div class="entry-title mb-10">
                                <a href="#">Blogpost With HTML video</a>
                            </div>
                            <div class="entry-meta mb-10">
                                <ul class="list-unstyled">
                                    <li><a href="#"><i class="fa fa-folder-open-o"></i> Design</a></li>
